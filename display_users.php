...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Selamat Datang di Toko Online Saya</h1>
        <p class="text-center">Temukan produk terbaik kami di bawah ini!</p>
    ...
    <footer class="bg-light text-center text-lg-start mt-4">
        <div class="text-center p-3">
            &copy; 2024 Toko Online Saya. Semua hak dilindungi.
        </div>
    </footer>
